											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="col-md-9">                                            
														<div class="input-group">
															<span class="input-group-addon"><span class="fa fa-user"></span></span>
															<input type="text" name="desg" class="form-control" value="<?php echo $user["desg"]?>" required/>
														</div>                                            
														<span class="help-block">Change to update your designation</span>
													</div>
												</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#profile-form').submit(function(e) {
					...
					if(conf) {
						$.ajax({
							url: "services/updateTeacherProfile.php", 
							type: "POST",        
