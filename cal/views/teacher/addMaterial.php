        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-file"></span> Add Material</h2>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" id="mat-form" method="post" action="services/addMaterial.php">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Upload</strong> Material</h3>
                                    
                                </div>
                                
                                <div class="panel-body">                                                                        
                                    
									<input type="hidden" name="classId" value="<?php echo $_GET["classId"]?>" required>
									
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Material Name</label>
									...
									<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Material Description</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="matDesc" rows="5" required></textarea>
                                            <span class="help-block">Add some description/instructions about the material.</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                                                                        
                                            <input type="file" class="fileinput btn-primary" name="material" id="filename" title="Select Material" required/>
                                        </div>
                                    </div>
